...
import weco.exceptions.InstagramLoginFailedException;
...
public class Instagram4j {
     ...
     * @throws InstagramLoginFailedException 
     */
    public InstagramLoginResult login() throws ClientProtocolException, IOException, InstagramLoginFailedException {
        ...
        if(loginResult.getStatus().equals("fail")){
        	...
        	if(loginResult.getError_type().equals("needs_upgrade")){
            	throw new InstagramLoginFailedException("Your version of instagram4j is outdated!");
        	}
        	throw new InstagramLoginFailedException(loginResult.getMessage());
        }
