...
public class InstagramConstants {
     ...
     */
    public static final String API_KEY = "68a04945eb02970e2e8d15266fc256f7295da123e123f44b88f09d594a5902df";
    
    /**
     * Instagram Version
     */
    public static final String VERSION = "10.8.0";
     ...
     * Android Release
     */
    public static final String USER_AGENT = String.format("Instagram " + VERSION + " Android (%s/%s; 320dpi; 720x1280; %s; %s; armani; qcom; en_US)",
