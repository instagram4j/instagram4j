...
@AllArgsConstructor
@Log4j
public class InstagramMutePostAndStoryRequest extends InstagramPostRequest<InstagramFriendshipStatus> {
    ...
    public InstagramFriendshipStatus parseResult(int statusCode, String content) {
        return parseJson(statusCode, content, InstagramFriendshipStatus.class);
    }
