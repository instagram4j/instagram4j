...
public class MediaSeenRequest extends IGPostRequest<IGResponse> {
    @NonNull
    private List<StoryMedia> reel_media_ids;
    ...
    public class MediaSeenPayload extends IGPayload {
        ...
        public MediaSeenPayload(List<StoryMedia> storyMedia) {
            this.reels = new HashMap<>();
            storyMedia.forEach(this::map_to_reels);
        }

        public void map_to_reels(StoryMedia media) {
