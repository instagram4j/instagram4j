package com.instagram4j.mobile;


import com.instagram4j.mobile.endpoints.direct.Inbox;
import com.instagram4j.mobile.endpoints.post.Post;
import com.instagram4j.mobile.endpoints.profile.Profile;
import com.instagram4j.mobile.endpoints.profile.ProfileData;
import com.instagram4j.mobile.endpoints.profile.Story;
import com.instagram4j.mobile.paginators.FeedPaginator;
import com.instagram4j.mobile.utils.Constants;
...
/**
 * Main interface for the instagram4j Mobile library.
...
public class Instagram4j {
     ...
     */
    public Instagram4j(String username, String password) throws IOException, InstagramException {
     ...
     */
    protected Instagram4j(String auth) {
        this.token = auth;
    }

    /**
     * Creates a instagram4j instance using an existing authentication token.
     *
     * @param auth The mobile auth token.
     * @return A new instagram4j instance.
     */
    public static Instagram4j getInstance(@NotNull String auth) {
        return new Instagram4j(auth);
    }
