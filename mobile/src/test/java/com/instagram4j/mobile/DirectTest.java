...
import com.instagram4j.mobile.endpoints.direct.Message;
import com.instagram4j.mobile.endpoints.direct.Thread;
import com.instagram4j.mobile.paginators.MessagePaginator;
...
public class DirectTest {
    ...
    @BeforeAll
    static void setup() {
        insta = Instagram4j.getInstance(AUTH_TOKEN);
    }
    ...
    void testSendMessage() throws InstagramException {
        ...
        if (!inbox.threads.isEmpty()) {
            ...
            assertDoesNotThrow(() -> thread.sendMessage("Test message from instagram4j JUnit"));
