...
import com.instagram4j.mobile.endpoints.post.Comment;
import com.instagram4j.mobile.endpoints.post.Post;
import com.instagram4j.mobile.paginators.CommentPaginator;
...
public class PostTest {
    ...
    void testCommentOnPost() throws InstagramException, IOException {
        Post post = insta.getPost(TEST_POST_URL);
        String commentText = "Test comment from instagram4j JUnit " + System.currentTimeMillis();
