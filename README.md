...
instagram4j
========
[ ![Download](https://api.bintray.com/packages/instagram4j/maven/instagram4j/images/download.svg?version=2.0.1) ](https://bintray.com/instagram4j/maven/instagram4j/2.0.1/link)
...
# Install
The latest stable release: [ ![Download](https://api.bintray.com/packages/instagram4j/maven/instagram4j/images/download.svg?version=2.0.1) ](https://bintray.com/instagram4j/maven/instagram4j/2.0.1/link)

#### Example for gradle:
```java
dependencies {
    implementation 'com.github.instagram4j:instagram4j:2.0.1'
}
```
