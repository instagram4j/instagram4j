...
# 📢 instagram4j is currently being rewritten. See annoucement [here](https://github.com/instagram4j/instagram4j/issues/459)
...
or Gradle:
```groovy
compile 'org.brunocvcunha.instagram4j:instagram4j:1.14'
```
