package com.instagram4j.web;

import com.instagram4j.web.endpoints.post.Post;
import com.instagram4j.web.endpoints.profile.Profile;
import com.instagram4j.web.endpoints.profile.Story;
import com.instagram4j.web.paginators.FeedPaginator;
...
public class Instagram4j {
     ...
     */
    protected Instagram4j(@NotNull String session, @NotNull String crsf, int retries) {
        this.session = session;
        this.crsf = crsf;
    }

    /**
     * Initializes instagram4j with an existing session.
     *
     * @param session The sessionId cookie.
     * @param crsf    The CSRF token.
     * @return A new instagram4j instance.
     */
    public static Instagram4j getInstance(@NotNull String session, @NotNull String crsf) {
        return new Instagram4j(session,crsf,3);
    }
