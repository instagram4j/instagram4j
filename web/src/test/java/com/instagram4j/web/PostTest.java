...
import com.instagram4j.web.endpoints.post.Comment;
import com.instagram4j.web.endpoints.post.Post;
import com.instagram4j.web.paginators.CommentPaginator;
...
public class PostTest {
    ...
    static void setup() throws InstagramException, IOException {
        insta = Instagram4j.getInstance(SESSION_ID, CSRF_TOKEN);
    }
